...
INSTANCE_ID = _e("KRYPTOTRON_INSTANCE_ID", "").strip()
if len(INSTANCE_ID) > 128 or not all(char.isalnum() or char in "_-" for char in INSTANCE_ID):
...
DCA_PRESETS = (5, 10, 20, 50, 100, 200, 500, 1000)
